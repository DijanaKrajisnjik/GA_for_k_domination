...
class VNS:
    def __init__(self, instance_name, graph: Graph, k: int, d_min: int, d_max_init: int, time_limit: int, iteration_max: int, prob: float, penalty: float, rseed : int):
...
if __name__ == '__main__':
    ...
    file_name_res = 'results/' + str(k) +'_tl'+str(time_limit)+'_it'+str(iteration_max)+'_seed'+str(rseed)+'.txt'
